...
import 'package:sealine_app/widgets/inventory_manager/buyer_req/buyer_req_stream.dart';
import 'package:sealine_app/widgets/logo.dart';

class BuyerReq extends StatelessWidget {
  const BuyerReq({Key? key}) : super(key: key);
